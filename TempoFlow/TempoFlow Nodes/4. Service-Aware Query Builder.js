...
// FIXED SERVICE LIST - from production_services.txt (109 services)
const FIXED_SERVICE_LIST = [
  "active-mq", "bss-crm-batch", "bss-mc-activity", "bss-mc-asset-management",
  "bss-mc-b2b-objectstorage", "bss-mc-cpq", "bss-mc-cpq-batch", "bss-mc-cpq-ntf-integrator",
  "bss-mc-crm-customer-information", "bss-mc-crm-customer-search", "bss-mc-crm-mash-up",
  "bss-mc-crm-ntf-integrator", "bss-mc-crm-search-integrator", "bss-mc-csr",
  "bss-mc-domain-config", "bss-mc-id-service", "bss-mc-message-relay", "bss-mc-ntf-engine",
  "bss-mc-ntf-history", "bss-mc-pcm-cfm", "bss-mc-pcm-cms-integrator-em-glb-prod",
  "bss-mc-pcm-cms-integrator-em-prod", "bss-mc-pcm-next-gen-admintoolbox-config-manager",
  "bss-mc-pcm-next-gen-admintoolbox-ui", "bss-mc-pcm-product-catalog",
  "bss-mc-pcm-product-offer-detail", "bss-mc-rim", "bss-mc-rim-ui", "bss-mc-ui-authz",
  "bss-mc-user-management", "bss-mc-user-management-em-glb-prod", "bss-mc-wsc-new",
  "bss-ntf-batch", "bss-services-service", "eca", "elasticsearch-coordinating-hl",
  "elasticsearch-data-hl", "elasticsearch-em-glb-prod", "elasticsearch-em-glb-prod-kibana",
  "elasticsearch-em-prod", "elasticsearch-em-prod-kibana", "elasticsearch-ingest-hl",
  "elasticsearch-master-hl", "elasticsearch-metrics", "eom-activemqqueueoperations-em-glb-prod",
  "eom-activemqqueueoperations-em-prod", "eom-castlemock", "eom-micro-flows-em-glb-prod",
  "eom-micro-flows-em-prod", "eom-operate-em-glb-prod", "eom-operate-em-prod",
  "eom-postgresqldboperations-em-glb-prod", "eom-postgresqldboperations-em-prod",
  "eom-scheduler-em-glb-prod", "eom-scheduler-em-prod", "eom-ui-em-glb-prod",
  "eom-ui-em-prod", "eom-zeebe-em-glb-prod-zeebe", "eom-zeebe-em-glb-prod-zeebe-gateway",
  "eom-zeebe-em-prod-zeebe", "eom-zeebe-em-prod-zeebe-gateway", "external-services-service",
  "fstp-activemq-artemis-em-glb-prod", "fstp-activemq-artemis-em-prod",
  "fstp-bpmn-ms-em-glb-prod", "fstp-bpmn-ms-em-prod", "fstp-configuration-ms-em-glb-prod",
  "fstp-configuration-ms-em-prod", "fstp-dashboard-ms-em-glb-prod", "fstp-dashboard-ms-em-prod",
  "fstp-eca-em-glb-prod", "fstp-eca-em-prod", "fstp-frontend-em-glb-prod",
  "fstp-frontend-em-prod", "fstp-orchestra-ms-em-glb-prod", "fstp-orchestra-ms-em-prod",
  "fstp-redis-em-glb-prod", "fstp-redis-em-prod", "fstp-scheduler-ms-em-glb-prod",
  "fstp-scheduler-ms-em-prod", "fstp-selenium-grid-em-glb-prod", "fstp-selenium-grid-em-prod",
  "gorules", "headless-eca", "kafka-cluster", "kafka-cluster-em-glb-prod-zookeeper",
  "kafka-cluster-em-glb-prod-zookeeper-headless", "kafka-cluster-em-prod-zookeeper",
  "kafka-cluster-em-prod-zookeeper-headless", "kafka-cluster-headless", "kafka-ui",
  "loyalty-services-service", "mariadb", "mariadb-235ae77b-7df2-448b-a14f-a512d968d1e4",
  "mariadb-def67a0f-e498-42cc-8d20-707939223b41", "nginx", "om-services-service",
  "php-fpm-exporter", "readreplica-mariadb-29f80350-ff6b-4860-a2ab-8336d07980d6",
  "readreplica-mariadb-2c40aad4-ff16-4e60-8e2e-d2983bc5891f", "redis", "redisinsight-ui",
  "redis-sentinel", "redis-sentinel-headless", "varnish", "wso2am-cp-1-service",
  "wso2am-cp-2-service", "wso2am-cp-service", "wso2am-gw-service"
];

// Use fixed service list instead of dynamic detection
enhancedParams.serviceAnalysis.detectedServices = FIXED_SERVICE_LIST;

// Build service metadata (keep dependency store logic for backward compatibility)
